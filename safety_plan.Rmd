...
params:
  repo_url: 'https://github.com/NewGraphEnvironment/safety_plan_peace_2024'
  report_url: 'https://newgraphenvironment.github.io/safety_plan_peace_2024'
...
link_kml <- paste0('https://github.com/NewGraphEnvironment/', name_repo, '/raw/main/mapping')
...
Presence/absence of fish, species composition/density and distribution limits can be useful for prioritizing which crossings are a best fit for fish passage restoration and help inform follow up monitoring so electrofishing and minnowtrapping may be conducted. Standard Fish and Fish Habitat Inventory Standard Field Form [site cards](https://www2.gov.bc.ca/assets/gov/environment/natural-resource-stewardship/nr-laws-policy/risc/scf.pdf) are used to gather habitat data, and the Field Guide to these site cards can be found [here](https://www2.gov.bc.ca/assets/gov/environment/natural-resource-stewardship/nr-laws-policy/risc/sitecard20.pdf).
...
zip::zipr(paste0("mapping/sites_", name_project_name, '_', format(Sys.Date(), "%Y%m%d"), '_kml.zip'), files = files_to_zip)  ##it does not work to zip to kmz!!
